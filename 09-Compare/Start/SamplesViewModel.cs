...
namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<int> ExceptProductSalesMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.Select(prod => prod.ProductID).Except(sales.Select(sale => sale.ProductID)).ToList();
    ...
    public List<int> IntersectProductSalesMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.Select(prod => prod.ProductID).Intersect(sales.Select(sale => sale.ProductID)).ToList();
    ...
    public List<Product> IntersectUsingComparerQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from lis in list1 select lis).Intersect(from listOne in list2 select listOne, pc).ToList();
    ...
    public List<Product> IntersectByProductSalesQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod in products select prod).IntersectBy<Product, int>(from sale in sales select sale.ProductID, prod => prod.ProductID).ToList();
    ...
    public List<Product> IntersectByProductSalesMethod()
    {
      ...
      list = products.Select(prod => prod).IntersectBy<Product, int>(sales.Select(sale => sale.ProductID), prod => prod.ProductID).ToList();
