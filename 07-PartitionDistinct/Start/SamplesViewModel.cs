  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<Product> SkipQuery()
    {
      ...
      list = (from prod in products
              orderby prod.Name
              select prod).SkipWhile(p => p.Name.StartsWith("h")).ToList();
      return list;
    }
    #endregion
    ...
    public List<Product> SkipMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.OrderBy(prod => prod.Name).SkipWhile(p => p.Name.StartsWith("a")).ToList();
    ...
    public List<string> DistinctQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod in products
              select prod.Color).Distinct().OrderBy(x => x).ToList();
    ...
    public List<string> DistinctWhere()
    {
      ...
      // Write Method Syntax Here
      list = products.Select(x => x.Color).OrderBy(x => x).Distinct().ToList();
    ...
    public List<Product> DistinctByQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod in products
              select prod).DistinctBy(x => x.Color).ToList();
    ...
    public List<Product> DistinctByMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.DistinctBy(x => x.Color).OrderBy(x => x).ToList();
    ...
    public List<Product[]> ChunkMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.Select(x => x).Chunk(5).ToList();
