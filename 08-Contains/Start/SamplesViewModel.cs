  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public bool AllQuery()
    {
      ...
      value = (from prod in products
               select prod).All(prod => prod.ListPrice > prod.StandardCost);
    ...
    public bool AllSalesMethod()
    {
      ...
      // Write Method Syntax Here
      value = sales.All(product => product.OrderQty >= 1);
    ...
    public bool AnyQuery()
    {
      ...
      // Write Query Syntax Here
      value = (from sale in sales select sale).Any(sale => sale.UnitPrice > 10000);
